...
type TraefikServiceSpecWeightedServices struct {
	...
	HealthCheck *TraefikServiceSpecWeightedServicesHealthCheck `field:"optional" json:"healthCheck" yaml:"healthCheck"`
	// Kind defines the kind of the Service.
	Kind TraefikServiceSpecWeightedServicesKind `field:"optional" json:"kind" yaml:"kind"`
	...
	Port TraefikServiceSpecWeightedServicesPort `field:"optional" json:"port" yaml:"port"`
	// ResponseForwarding defines how Traefik forwards the response from the upstream Kubernetes Service to the client.
	ResponseForwarding *TraefikServiceSpecWeightedServicesResponseForwarding `field:"optional" json:"responseForwarding" yaml:"responseForwarding"`
	...
	Sticky *TraefikServiceSpecWeightedServicesSticky `field:"optional" json:"sticky" yaml:"sticky"`
