...
func NewIngressRoute(scope constructs.Construct, id string, props *RouteProps) traefikio.IngressRoute {
...
func routes(props *RouteProps) *[]*traefikio.IngressRouteSpecRoutes {
...
func ingressRouteServices(props *RouteProps) []*traefikio.IngressRouteSpecRoutesServices {
